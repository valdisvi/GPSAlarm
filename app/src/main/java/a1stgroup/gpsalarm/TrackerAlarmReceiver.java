...
public class TrackerAlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void setAlarm(Context context) {
        ...
        alarmManager.setInexactRepeating(AlarmManager.ELAPSED_REALTIME_WAKEUP,MapsActivity.locationUpdateFrequency,
                MapsActivity.locationUpdateFrequency,alarmIntent);
